...
- Simple          - 1.836 byte
composable("components.Observable_SignalsAndSlots",function(k,d,q){k=d.Array;var s=d.Math.random,r=q.introspective,l=r.isFunction,g=r.isString,t=l(k.from)&&k.from||q.helpers.makeArray,u=d.uuid&&l(d.uuid.v4)&&d.uuid.v4||function a(e){return e?(e^16*s()>>e/4).toString(16):([1E7]+-1E3+-4E3+-8E3+-1E11).replace(/[018]/g,a)},v=function(a,e){this.target=a;this.type=e;this.uuid=u()},p=function(a,e,g){var c=new v(a,e);this.constructor=p;this.handleEvent=function(a){a&&"object"==typeof a?(a.target=c.target,a.type=c.type,a.uuid=c.uuid):a={target:c.target,type:c.type,uuid:c.uuid};g(a)};this.getType=function(){return e};this.getHandler=function(){return g}};return function(a){a="object"==typeof a&&a||{};var e={},d="addEventListener",c="removeEventListener",m="hasEventListener",n="dispatchEvent",k=function(h,a){var b=e[h],f=!1;if(b){var g=b.handlerList,b=b.listenerList,c=g.indexOf(a);0<=c&&(g.splice(c,1),b.splice(c,1),f=!0)}return f},d=g(a[d])?a[d]:d,c=g(a[c])?a[c]:c,m=g(a[m])?a[m]:m,n=g(a[n])?a[n]:n;this[d]=function(h,a){var b;if(h&&g(h)&&l(a)){var f=e[h];b=new p(this,h,a);if(f){var c=f.handlerList,f=f.listenerList,d=c.indexOf(a);-1==d?(c.push(b.getHandler()),f.push(b)):b=f[d]}else f=e[h]={},f.handlerList=[b.getHandler()],f.listenerList=[b]}return b};this[c]=function(a,c){return g(a)&&l(c)&&k(a,c)||a instanceof p&&k(a.getType(),a.getHandler())||!1};this[m]=function(a,c){var b;if(!(b=g(a)&&l(c)&&(e[a]||!1)&&0<=e[a].handlerList.indexOf(c))){if(b=a instanceof p){b=a.getType();var f=a.getHandler();b=(e[b]||!1)&&0<=e[b].handlerList.indexOf(f)}b=b||!1}return b};this[n]=function(a){var c=!1,b=a&&"object"==typeof a&&g(a.type)&&a.type||g(a)&&(a={type:a})&&a.type||"";if(b=b&&e[b]){var f=(b=b.listenerList&&t(b.listenerList))&&b.length||0,d=-1;if(1<=f){for(;++d<f;)b[d].handleEvent(a);c=!0}}return c};""in this&&delete this[""]}});
