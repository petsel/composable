...
composable("components.Propagable_EventProxy", function (require, global, internalBaseEnvironment) {
  ...
  var
    ...
    isEvent = function (type) {       // was: isCurrentTargetEvent
      return (
...
- Simple          -   303 byte
composable("components.Propagable_EventProxy",function(a,e,b){a=b.introspective;var c=a.isObject,d=a.isString;return function(){if(c(this.target)&&d(this.type)){var a=!1;this.stopImmediatePropagation=function(){a=!0};this.stopPropagation=function(){a=!0};this.isStopPropagation=function(){return a}}}});
