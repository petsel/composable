...
composable("components.Iterable_Character_next_previous", function (require, global/*, environment*/) {
...
- Simple          -   415 byte
composable("components.Iterable_Character_next_previous",function(d,e){var f=d("entities.IterableFactory"),c=e.String.fromCharCode;return f.create({next:function(){var b=""+this,a;1==b.length&&(a=c(b.charCodeAt(0)+1),a=""!==a&&a!==b?a:void 0);return a},previous:function(){var b=""+this,a;1==b.length&&(a=c(b.charCodeAt(0)-1),a=""!==a&&a!==b?a:void 0);return a},compare:function(b,a){return b<a&&-1||b>a&&1||0}})});
