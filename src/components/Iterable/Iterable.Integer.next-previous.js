...
composable("components.Iterable_Integer_next_previous", function (require, global/*, environment*/) {
...
- Simple          -   422 byte
composable("components.Iterable_Integer_next_previous",function(g,c){var h=g("entities.IterableFactory"),j=c.Number,d=c.Math,e=c.isFinite,k=d.floor,l=d.pow(-2,53),m=d.pow(2,53),f=function(a){return e(a=j(a))&&a<=m&&a>=l?k(a):void 0};return h.create({next:function(){var a=f(this),b=a+1;return e(b)&&b!==a?b:void 0},previous:function(){var a=f(this),b=a-1;return e(b)&&b!==a?b:void 0},compare:function(a,b){return a-b}})});
