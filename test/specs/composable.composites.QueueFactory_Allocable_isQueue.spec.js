...
describe("»composites.QueueFactory_Allocable_isQueue« module", function () {
  ...
  var
    ...
    QueueFactory = require("composites.QueueFactory_Allocable_isQueue"),
  ...
  it("should - if required via »( composable. )require(\"composites.QueueFactory_Allocable_isQueue\")« - always be a real \"object\" type.", function () {
  ...
  describe("This module being a [Queue] factory too", function () {
    ...
    it([
      "should feature three methods - [create], [isQueue] and [all]."

    ].join(" "), function () {

      expect(typeof QueueFactory.create).toBe("function");
      expect(typeof QueueFactory.isQueue).toBe("function");
    ...
    it([
      ...
      "It should pass every test of the [QueueFactory] specification."
...
//    ].join(" "), function () {
    ...
    it([
      ...
      "It should pass every test of the [QueueFactory_isQueue] specification."

    ].join(" "), function () {

      expect(QueueFactory.isQueue(queue_1)).toBe(true);
      expect(QueueFactory.isQueue(queue_2)).toBe(true);
      expect(QueueFactory.isQueue(queue_3)).toBe(true);

      expect(QueueFactory.isQueue()).toBe(false);
      expect(QueueFactory.isQueue(QueueFactory)).toBe(false);


      // method API comparison
      expect(QueueFactory.isQueue(require("composites.QueueFactory").create())).toBe(true);

      // method API comparison
      expect(QueueFactory.isQueue(require("composites.QueueFactory_isQueue").create())).toBe(true);


      /**
       *  does manipulate upcoming "QueueFactory_Allocable ..." tests - do not rely on this 2 expectations below
       */
//
//        // method API comparison
//        expect(QueueFactory.isQueue(require("composites.QueueFactory_Allocable").create())).toBe(true);
//
//        // instanceof comparison
//        expect(QueueFactory.isQueue(require("composites.QueueFactory_Allocable_isQueue").create())).toBe(true);
    });
    ...
    it([
      ...
      "It should pass every test of the [QueueFactory_Allocable] specification."
