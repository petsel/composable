...
describe("»composites.QueueFactory_isQueue« module", function () {
  ...
  var
    ...
    QueueFactory = require("composites.QueueFactory_isQueue"),
  ...
  it("should - if required via »( composable. )require(\"composites.QueueFactory_isQueue\")« - always be a real \"object\" type.", function () {
  ...
  describe("This module being a [Queue] factory too", function () {
    ...
    it([
      "should feature two methods - [create] and [isQueue]."
...
//    ].join(" "), function () {
    ...
    describe("In addition to its [create] method this factory does feature an [isQueue] method", function () {

      it([

        "that expects a single parameter - the type that is going to be tested",
        "of whether being a [Queue] type or not."
