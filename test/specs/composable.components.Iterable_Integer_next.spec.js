  ...
  describe("This module being a factory", function () {
    ...
    describe("should - if applied onto a number object - ", function () {
      it([
        ...
        // traits do work on objects only - not on primitives.        // but test only fails within Safari.
        expect(Iterable_Integer_next.call(5)).toBe(5);
        expect(typeof Iterable_Integer_next.call(5)).toBe("number");

        expect(Iterable_Integer_next.call(5).next).toBeUndefined();
...
//      ].join(" "), function () {
//
//        expect(Iterable_Integer_next.create.length).toBe(1);
//      });
//
//      it([
...
//      ].join(" "), function () {
//
//        Iterable_1 = Iterable_Integer_next.create();
//        Iterable_2 = Iterable_Integer_next.create();
//        Iterable_3 = Iterable_Integer_next.create();
//
...
//          }
//        });
//      //Iterable_3 = Iterable_Integer_next.create(); // see above.
//
//        expect(typeof Iterable_1).toBe("function");
//        expect(typeof Iterable_2).toBe("function");
//        expect(typeof Iterable_3).toBe("function");
...
//          });
//
//          describe("Looking at the [Iterable_Integer_next] and its static method [isStopIteration] ...", function () {
//            it([
//
...
//            ].join(" "), function () {
//
//              expect(Iterable_Integer_next.isStopIteration.length).toBe(1);
//            });
//
//            it([
...
//            ].join(" "), function () {
//
//              expect(Iterable_Integer_next.isStopIteration(stopIterationException)).toBe(true);
//
//              expect(Iterable_Integer_next.isStopIteration()).toBe(false);
//              expect(Iterable_Integer_next.isStopIteration(0)).toBe(false);
//              expect(Iterable_Integer_next.isStopIteration("")).toBe(false);
//              expect(Iterable_Integer_next.isStopIteration(GLOBAL_OBJECT)).toBe(false);
//              expect(Iterable_Integer_next.isStopIteration({toString:function(){return "[object StopIteration]";}})).toBe(false);
//            });
//          });
//        });
//      });
